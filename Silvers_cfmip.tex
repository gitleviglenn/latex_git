...
Over the recent decades which have had excellent/global satellite coverage both amip and historical experiments significantly underestimate (10-15\%)
the observed cloud fraction.  This is especially true for low-level, optically thin clouds between $pm 30$.  The comparison with observed TOA 
radiative fluxes for AM4/CM4 is quite good, which combined with the under-estimate of cloud fraction implies the presence of the so-called
'too few, too bright' cloud bias which was also present in CMIP3 and CMIP5 global climate models.   

What additional constraints can we recommend for GCMs?  

\textit{Numerous studies have documented the range of sensitivities among an ensemble of models from different
generations of CMIP and from a wide range of modeling centers (e.g. Cess et al. 1989, Andrews et al., 2012, Rinter et al., 2014, Zelinka et al., 2020).  In contrast, this study focuses on several models from a single modeling center, all based on the same generation of code.  By so doing we can more clearly attach the source of spread in the climate sensitivity not to 
differences in the microphysics or convection parameterizations but to differences in the geophysical configuration and to the responses of the clouds to different boundary 
conditions... with less ambiguity.}

We have identified/quantified the part of the climate feedback parameter in each experiment that is simply due to differences in the 
geophysical configuration (e.g. presence of land, sea-ice, etc.).  In addition we illustrate the range of CRE feedbacks among the 
experiments with AM4/CM4 and show how these CRE feedbacks vary as a function of latitude.  Overall the SH emerges as a  primary 
...
subsequent positive shift of the SW CRE in the experiments which are most sensitive to CO2 perturbations (abrupt 4xCO2 and 1pct CO2).
...
A substantial portion (quantify) of the range in CS among the AM4/CM4 experiments examined here is due to 
driven by a range in the CRE.  However, the differences in cloud fraction among the experiments is smaller than 
the bias of the recent decades relative to observations.  Can we say that reducing the observational cloud bias
