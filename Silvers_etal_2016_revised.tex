...
\begin{table}
    ...
    \hline
    Domain    &          Area  ($\rm{km}^2$)         & Edge Length (km)            &   Grid Points    &   SST (K)          & Length (year)    & P1 (year) & P2 (month)     \\ \hline
    3/4M        &   $\mathrm{0.80\times 10^6}$   &  960 $\times$ 831            &    4,608            &  297/301           & 10                     & 9             & 12                    \\
    \\
    3M           & $\mathrm{3.2\times 10^6}$       & 1,920 $\times$ 1,663        &  18,432           &   297/301          & 10                     & 9              & 4                                   \\ 
    \\
    12M         & $\mathrm{12.8\times 10^6}$     & 3,840 $\times$ 3,326        &   73,728          & 297/301            &   4                     & 3              & 8                                               \\ 
    \\
    50M         & $\mathrm{51.1\times 10^6}$     & 7,680 $\times$ 6,651        &  294,912         & 297/301            &    2                    &  1              & 4                                                \\ 
    \\
    200M       & $\mathrm{204\times 10^6} $     & 15,360 $\times$ 13,302     & 1,179,648      & 297/301            &    1                    &  0.6          &  0.76                                     \\ \hline
     \end{tabular}\par
     \label{exptable}
\end{center}
\end{table}
...
\begin{table}
\begin{center}
\caption{Mean Energetics: Long- and short-wave feedback parameters, total feedback parameter, equilibrium climate sensitivity and hydrologic sensitivity parameter (HSP) (defined as $\Delta P/\Delta T_s$, where $P$ is the total precipitation) as a function of domain size.   Values were averaged over the P1 period.}
 ...
 Domain & $\lambda_{sw}/\lambda_{sw,clr} (\mathrm{W/m^2 K}) $& $\lambda_{lw}/\lambda_{lw,clr}  (\mathrm{W/m^2 K}) $ &   $\lambda  (\mathrm{W/m^2 K}) $ & ECS (K) & HSP ($\mathrm{\%/K}$)   \\ \hline
    0.75 M          &   0.08/0.25    & -1.93/-2.13              & -1.85  $\pm (0.4/0.4)$           &  2.00           &        2.3     \\ 
    \\
    3M                & -0.89/0.25     & -1.49/-1.55            & -2.39 $\pm (0.3/0.3)$         & 1.55                &   1.9  \\  
    \\
    12M             & 0.13/0.23      & -2.28/-2.48             & -2.15 $\pm (0.3/0.2)$          & 1.72                &  2.6   \\  
    \\
    50M             & 1.71/0.25      & -2.84/-2.05             & -1.13 $\pm (0.2/0.2)$           & 3.29               &  2.7  \\  
    \\
    200M          & 0.92/0.25      & -2.51/-2.25             & -1.59  $\pm (0.2/0.1)$          & 2.33                &   2.7    \\  \hline
    \end{tabular}\par
    %\bigskip 
    \label{tab:lambda}
\end{center}
...
\begin{table}
    \caption{Total cloud cover and column integrated diagnostics.  Water Vapor ($q_v$), Liquid Water ($q_c$), and Ice ($q_i$).  Values were computed over the P2 period.}
    \begin{center}
    %\begin{tabular}{| l | l | l | l | p{5cm} |}
    %\begin{tabular}{l*{3}{c}r}
    \begin{tabular}{*{6}{c}}
    ...
    %\multicolumn{5}{|c|}{Experimental Specifications} \\
    \hline
    Domain      & Tot Cloud Cover (\%)        & $q_v (\mathrm{kg/m^2}) $  &   $q_c (\mathrm{g/m^2}) $   & $q_i (\mathrm{g/m^2})$    & SST (K)   \\ \hline
    3/4M           &   $\mathrm{82}$  &    39.7            &  15.3    & 6.16              & 297                            \\
                       &       81                &   55.5             &   17.7   & 6.17              & 301  \\
                       \\
 %                         &                                                       &                         &  301 K    &  10 years                                         \\ \hline
    3M                & $\mathrm{73}$   &  36.4            &   22.2   &      5.03          & 297                                 \\ 
                         &           75             &   52.5             &   25.8  & 5.64               & 301  \\
    \\
 %                         &                                                              &                          &  301 K    &   10 years                                               \\ \hline
    12M              & $\mathrm{67}$ &  36.4          & 20.4    &        5.26              & 297                                      \\ 
                         &       63              &   49.7          & 39.3    &        6.35             & 301  \\
    \\
  %                        &                                                 &                       & 301K       &       4 years                                                \\ \hline
    50M               & $\mathrm{63}$ &  37.0     & 24.2      &    5.54                & 297                                    \\ 
                          &       58               &  51.1     &  21.1     &    6.64               & 301  \\
    \\
   %                       &                                                 &                                     & 301 K     &         2 years                                              \\ \hline
    200M            & $\mathrm{64} $ &  36.9      & 22.5  &        5.60                  & 297                       \\
                         &       57                &  51.9      & 26.4  &        6.74                 & 301     \\ \hline
    %                      &                                                 &                                     &  301 K               &     1 year                        \\ \hline
     \end{tabular}\par
     \label{colintvars}
\end{center}
...
\begin{figure}[!htb]
   ...
   \end{minipage}
  \caption{Snapshots in time of total precipitation ($\rm{mm \,day^{-1}}$) for the $\rm{3/4 M (left), 12 M (middle),}$ and $\rm{200M (right)}$ domains tiled according to scale.  Times and colors are same as for Fig. \ref{fig:precvsdom}, $\rm{SST}=301 \, \rm{K}$.}
  \label{fig:convorg}
\end{figure}
...
\begin{figure}[h] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=6.7in]{fig5_browns.eps}
   %\includegraphics[width=6.7in]{rce_ecs_20km_297_vprof_green.eps}
   \caption{Mean vertical profiles with a constant SST of 297 K.  Values were computed over the P2 period.}
   \label{fig:prof297}
\end{figure}
...
\begin{figure}[h] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=6.5in]{fig7_lthick2_green.eps}
   %\includegraphics[width=6.5in]{rce_ecs_20km_reldiff_24km_green.eps}
   \caption{Difference ($301 \rm{K} - 297 \rm{K}$) of mean vertical profiles between the two sets of fixed SST cases.  Values were computed over the P2 period.}
   \label{fig:profdiff}
\end{figure}
...
\begin{figure}[h] %  figure placement: here, top, bottom, or page
   ...
   \caption{Same data as Figure \ref{fig:profdiff}, zoomed in to reveal boundary layer features.  Values were computed over the P2 period.}
   \label{fig:profdiffzoom}
\end{figure}

\begin{figure}[h] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=6.5in]{vprofile_diffrel200M.eps}
   \caption{Same data as Figure \ref{fig:profdiff}, plotted relative to the 200M domain.  Values were computed over the P2 period.}
   \label{fig:profdiffrel200M}
\end{figure}
