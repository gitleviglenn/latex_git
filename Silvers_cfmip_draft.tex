...
the clouds which are simulated by AM4.0 over the recent observational period of 1979-2014.  We do this by comparing
...
used the satellite simulators which are included in COSP as part of the efforts of the CFMIP community 
(Bodas-Salcedo et al. 2011).  By using multiple complimentary satellite datasets and simulators we can benefit from 
the different strengths of each satellite while largely circumventing the known problems and discrepancies of the 
observational data sets.      

As a starting point we look at the total cloud fraction.  The ISCCP and CALIPSO products agree fairly well on the 
